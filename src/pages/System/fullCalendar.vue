    ...
    <div class="full-calendar-body">
      ...
      <div class="dates" ref="dates">
        ...
        <div class="dates-events">
          <div class="events-week" v-for="week in currentDates" track-by="$index">
            <div class="events-day" v-for="day in week" track-by="$index"
                 :class="{'today' : day.isToday,
              'not-cur-month' : !day.isCurMonth}" @click.stop="dayClick(day.date, $event)">
              <p class="day-number">{{day.monthDay}}</p>
              <div class="event-box">
                <event-card :event="event" :date="day.date" :firstDay="firstDay" v-for="event in day.events" :key="day.events.id" v-show="event.cellIndex <= eventLimit" @click="eventClick">
...
import fcHeader from "@/components/MonthChange";
